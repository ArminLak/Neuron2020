...
start = -1
stop=1
load('MiceExpInfo')                                                               % load beh data databse
...
TrialTimingData(TrialTimingData(:,3)==-1,3)=0; % define left choice as 0
...
colorCorrError=make3color([1 0 0], [ 0 0 0], [0 1 0],length(Stimz));
